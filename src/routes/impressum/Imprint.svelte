...
<section id="services" class="bg-gray-50 py-16 md:py-24">
	<div class="container mx-auto px-4 md:px-6">
		<div class="mb-16 text-center">
			<h2 class="mt-12 mb-4 font-serif text-3xl font-bold text-gray-900 md:text-4xl">Impressum</h2>
		</div>
		...
		<p>
			...
			Krittiya Gundlach<br />
		</p>
		<p>
			<strong>Kontakt:</strong> <br />
			Telefon: +4915901413451<br />
			E-Mail: <a href="mailto:mail@mwellnessmassage.de">info@mwellnessmassage.de</a><br />
		</p>
		<p>
		...
		<br />
		Erstellt mit dem <a href="https://impressum-generator.de" rel="dofollow">Impressum-Generator</a>
		...
		>
		und <a href="https://websitewissen.com/shopsysteme-vergleich" rel="dofollow">Shopsysteme</a>.
		Rechtstext von der
